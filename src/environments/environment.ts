...
export const environment = {
  ...
  socialMediaUrl: "http://localhost:8080/api/v1/social-media",
  vendorUrl: "http://localhost:8080/api/v1/vendor",
  multimediaUrl: "http://localhost:8080/api/multimedia",
  consultantUrl: "http://localhost:8080/api/v1/consultant",
  LangUrl: "http://localhost:8080/api/v1/language",
  CourseLevel: "http://localhost:8080/api/v1/course-level",
